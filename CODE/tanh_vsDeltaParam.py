...
surf = ax.plot_surface(X, D, Z, rstride=1, cstride=1)#, cmap="gnuplot2")
fake2Dline = mpl.lines.Line2D([0],[0], linestyle="none", c='b', marker = 'o')
plt.legend([fake2Dline], [r'$u_0$=.5, $V_0$=1.2, $\delta$=.1, $\eta$=.5, $\beta$=5.42'], numpoints = 1)
#ax.set_title(r'$\sqrt{\frac{6r}{p}}(1+tanh(x-8rt))$')
ax.view_init(20, 220)
#fig.colorbar(surf, shrink=0.5)
plt.savefig('C:\\Users\\nlpl9\\Desktop\\plasma-proj\\Graphs\\tanh_phivsDelta', transperant=True, dpi=144)
plt.show()
